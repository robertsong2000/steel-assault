...
export const LEVELS = [
  ...
  },
  {
    ...
    oneways: [
      ...
      { x: 830,  y: 320, w: 100, h: 14, kind: 'crumble' },
      { x: 1100, y: 360, w: 150, h: 14, kind: 'metal' },
      { x: 1480, y: 330, w: 100, h: 14, kind: 'metal', move: { range: 70, speed: 55, phase: 0 } },
      { x: 1750, y: 300, w: 140, h: 14, kind: 'metal' },
      { x: 2180, y: 340, w: 110, h: 14, kind: 'crumble' },
      { x: 2600, y: 280, w: 140, h: 14, kind: 'metal' },
      { x: 2970, y: 330, w: 110, h: 14, kind: 'metal', move: { range: 80, speed: 65, phase: 1.4 } },
      { x: 3400, y: 350, w: 140, h: 14, kind: 'crumble' },
      { x: 3790, y: 320, w: 110, h: 14, kind: 'crumble' },
      { x: 4200, y: 280, w: 140, h: 14, kind: 'metal' },
      { x: 4590, y: 340, w: 100, h: 14, kind: 'crumble' },
      { x: 4900, y: 320, w: 160, h: 14, kind: 'metal' },
    ],
    turrets: [
      { x: 560,  y: 350 },
      { x: 2660, y: 280 },
  ...
  },
  {
    ...
    oneways: [
      ...
      { x: 1350, y: 320, w: 140, h: 14, kind: 'metal' },
      { x: 2150, y: 290, w: 130, h: 14, kind: 'metal' },
      { x: 2550, y: 350, w: 150, h: 14, kind: 'metal' },
      { x: 2890, y: 330, w: 100, h: 14, kind: 'crumble' },
      { x: 3450, y: 280, w: 140, h: 14, kind: 'metal' },
      { x: 4050, y: 330, w: 140, h: 14, kind: 'metal' },
